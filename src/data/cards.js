...
export const CARDS = [
  ...
  { id: "faith_shield", name: "Faith Shield", type: CARD_TYPES.DEFENSE, rarity: RARITIES.COMMON, cost: 1, value: 5, icon: "🛡️", verse: "Ephesians 6:16", description: "Take up the shield of faith." },
  { id: "prayer", name: "Prayer", type: CARD_TYPES.SCRIPTURE, rarity: RARITIES.COMMON, cost: 1, value: 4, icon: "🙏", verse: "1 Thess 5:17", description: "Pray without ceasing. Heal 4 HP." },
