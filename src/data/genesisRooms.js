...
export const STORY_CHOICES = [
  {
    ...
    icon: "🍎",
    summary: "Eve faces the serpent's temptation in the Garden of Eden.",
  ...
  },
  {
    ...
    icon: "😡",
    summary: "God warns Cain that sin is waiting to consume him.",
  ...
  },
  {
    ...
    icon: "🔪",
    summary: "Abraham's faith is tested when God asks him to sacrifice Isaac.",
  ...
  },
  {
    ...
    icon: "⛵",
    summary: "Noah builds an ark in faith as the flood approaches.",
  ...
  },
  {
    ...
    icon: "🏰",
    summary: "Humanity plans a tower to reach the heavens in pride.",
